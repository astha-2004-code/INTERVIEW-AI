            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    >
                        ...
                        {loading ? 'Downloading PDF...' : 'Download Resume'}
                    </button>
                    <div style={{ marginTop: 'auto', paddingTop: '1rem', borderTop: '1px solid #e2e8f0', width: '100%', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <button
                            onClick={() => navigate('/')}
